...
novpnfile = '/usr/share/enigma2/Multibox_mod/SambaVpnIp/novpn.txt'
isvpnfile = '/usr/share/enigma2/Multibox_mod/SambaVpnIp/isvpn.txt'
...
class AMB_SambaVpnIp(Poll, Converter, object):
