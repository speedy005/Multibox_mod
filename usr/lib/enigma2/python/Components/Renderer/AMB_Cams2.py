...
class AMB_Cams2(Renderer, Poll):
    ...
    def __init__(self):
        ...
        self.nameCache = {}
        self.pngname = ''
        self.path = 'usr/share/enigma2/name_skin/test/piconCrypt/'
                            ...
                            if pngname == '':
                                ...
                                if pngname == '':
                                    ...
                                    if fileExists(tmp):
                                        ...
                                        pngname = resolveFilename(SCOPE_SKIN_IMAGE, 'usr/share/enigma2/Multibox/test/piconCrypt/Crypt.png')
